...
export class ResumeComponent implements OnInit, OnChanges {
  ...
  constructor() {
    ...
    const job_1: Job = new Job('C# Developer and Full Stack Developper', 'Since 2021', 'EXAUD',
      '<P>' 
    ...
    const trabalho_1: Job = new Job('Progamador C# e Full Stack', 'Desde 2021', 'EXAUD',
      '<P>' 
    ...
    this.jobsEnglish = [job_1,job_2,school_1,job_3,school_2];
    this.jobsPortuguese = [trabalho_1,trabalho_2,escola_1, trabalho_3,escola_2];
